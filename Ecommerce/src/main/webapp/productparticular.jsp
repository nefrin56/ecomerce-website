...
try
{
    ...
    <form action="#" method="post">
        <h5>username</h5><input type="text"  value=<%=a1 %> name="n5">
    	
    	<h5>Productname</h5><input type="text" value=<%= rs.getString(2) %> name="n1">
    	<h5>Productprice</h5><input type="text" value=<%= rs.getString(3) %> name="n2">
    	<h5>address</h5>
